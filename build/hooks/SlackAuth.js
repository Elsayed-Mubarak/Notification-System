...
var SlackAuth = /** @class */ (function () {
    function SlackAuth(SLACK_WEBHOOK_URL) {
        this.proxy = (0, https_proxy_agent_1.default)(process.env.http_proxy || 'http://localhost:7000');
        this.webhook = new IncomingWebhook(SLACK_WEBHOOK_URL, { agent: this.proxy });
    }
    SlackAuth.prototype.getHook = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.webhook.send({
